...
const SidebarLinks = () => {
  ...
  return (
    ...
    >
        ...
        <Link
          to={"/students"}
          className={`md:w-full transition-colors hover:bg-[var(--light)] hover:border-transparent hover:text-[var(--dark)]
            text-[var(--light)] hover:rounded    items-center ${
