...
const ClassRegFormSubmit :FC<{loading:boolean}> = ({loading}) => {
    return (
      <div className='w-full flex items-center justify-end px-4 my-4'>
           <Button disabled={loading} className="bg-dark w-full dark:hover:text-white hover:border-darker dark:bg-darker text-white border border-dark hover:text-dark" type='submit'>
