...
const StudentContactDetails = () => {
  const {Student:{email,contact,WA}} =
  ...
  return (
    <div className="flex gap-2  flex-wrap w-full px-4 py-4">
            ...
            dark:bg-dark hover:bg-dark hover:text-white transition-colors dark:text-white p-2 rounded-md">
            ...
            text-dark dark:text-white bg-light dark:bg-dark  hover:bg-dark hover:!text-white transition-colors p-2 rounded-md">
              <MdMail   className="text-2xl max-md:text-xl"/>
            </a>
            <a href={`tel:+92${contact[0]?.split("92")[1]||contact[0]}`}  target="_blank" className="center text-dark bg-light dark:bg-dark hover:bg-dark hover:text-white transition-colors dark:text-white p-2 rounded-md">
