...
const StudentClassSelect = () => {
  ...
  return (
    ...
    <SelectTrigger className="w-[120px] max-md:w-full   h-12   bg-box dark:bg-dark dark:text-white border-2 border-[var(--dark)] focus-visible:ring-offset-0 focus:ring-0 focus:ring-offset-0 focus-visible:ring-transparent ring-offset-0 ring-0 outline-none rounded-md relative">
