...
return  <Tooltip title={"GRNO is availble"}>
 ...
 disabled={edit}
  ...
  <Input  {...field} type="number"  onChange={(e)=>{field.onChange(e);debounced(e.target.value)}} placeholder="189305" suffix={<GRSuffix/>} className="active:border-[var(--dark)] dark:bg-dark dark:border-darker dark:text-white dark:placeholder:text-gray-600" />
  {
    isError&&
