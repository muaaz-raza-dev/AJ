...
const ClassHistorySection = () => {
  ...
  return (
    <div className="w-full bg-[var(--box)] flex flex-col gap-4 p-3 pb-6 ">
...
<div className="w-full overflow-auto">
      ...
      <div className=" w-[33%] inline-flex   items-center justify-start gap-1 ">
        <div className=" w-[78%] bg-dark text-white p-2 rounded-lg">
        ...
        <Tooltip title={"to the registered first Class "}>
           <Separator className="bg-darker h-1 rounded-full w-[20%]"/>
        </Tooltip>
        </div>
...

     {
      history.map((his,i)=>{
        ...
        <div className=" w-[78%] bg-dark_dimmer text-black p-2 rounded-lg">
