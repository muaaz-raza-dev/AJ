...
const EachYearlyHistoryComp:FC<{data:IfeeHistory}> = ({data})  =>{
  ...
  return <div onClick={handleClick} className="w-[49%] min-h-24 max-sm:w-full  p-2 bg-light  shadow text-dark dark:bg-darker dark:text-white  rounded-md flex flex-col gap-1">
