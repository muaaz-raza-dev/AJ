...
const HistoryFileHeaderSection = () => {
  ...
  return (
    ...
    <div className="flex justify-between bg-gradient-to-bl to-[#fd5353cb]  from-dark overflow-hidden relative w-[33%]  rounded-xl shadow  gap-2  h-32">
...
<div className="flex justify-between bg-gradient-to-bl to-[#1eba62da]   from-dark overflow-hidden relative w-[33%]  rounded-xl shadow-md   gap-2  h-32">
    <div className="flex flex-col gap-2 w-full p-4 py-8">
