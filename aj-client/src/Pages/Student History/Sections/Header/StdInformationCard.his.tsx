...
const StdInformationCard = () => {
  ...
  return (
    <div className="flex justify-between bg-gradient-to-bl text-white to-dark_dimmer   from-dark overflow-hidden relative w-[33%]  rounded-xl shadow-md   gap-2  h-32">
