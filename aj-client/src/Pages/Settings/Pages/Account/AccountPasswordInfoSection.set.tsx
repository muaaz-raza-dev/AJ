...
const AccountPasswordInfoSection = () => {
    ...
    const {watch  ,setValue} =useFormContext<IaccountInfo>()
    const password =watch("isUpdatePassword")
    const currentPaswword = watch("Passwords.currentPassword")
    const handlePasswordValidation = (type:"password"|"rpassword",val:string)=>{
        if(type=="password") {
