...
const SettingsLabelWrapper:FC<{description?:string,label:string , children?:ReactNode,className?:string}> = ({label,className,description,children}) => {
  return (
    <div className="flex items-center border-b border-gray-200 py-4  gap-1  w-full">
    <div className={`w-[40%] flex flex-col ${className} gap-1`}>
